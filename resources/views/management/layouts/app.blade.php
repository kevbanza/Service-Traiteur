...
<head>
  ...
  <title>BoraBoraFoods Management</title>
  <!--<link rel="shortcut icon" type="image/png" href="{{asset('assets/management/images/logos/favicon.png')}}" />-->
...
<body>
      ...
      <div>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="{{route('orders.traiteur')}}" aria-expanded="false">
                <span>
                  <i class="fa fa-calendar"></i>
                </span>
                <span class="hide-menu">Service Traiteur</span>
              </a>
            </li>
            <li class="sidebar-item">
            ...
            <ul class="navbar-nav flex-row ms-auto align-items-center justify-content-end">
              <li class="nav-item dropdown">
                <a class="nav-link nav-icon-hover" href="javascript:void(0)" id="drop2" data-bs-toggle="dropdown"
                  aria-expanded="false">
                  <img src="{{asset('assets/management/images/profile/user-1.jpg')}}" alt="" width="35" height="35" class="rounded-circle">
                </a>
  ...
  <script src="{{asset('assets/management/js/sidebarmenu.js')}}"></script>
  <script src="{{asset('assets/management/js/app.min.js')}}"></script>
  <script src="{{asset('assets/management/libs/apexcharts/dist/apexcharts.min.js')}}"></script>
  <script src="{{asset('assets/management/libs/simplebar/dist/simplebar.js')}}"></script>
  <script src="{{asset('assets/management/js/dashboard.js')}}"></script>
  @yield('script')
</body>
