              ...
              <div class="card-body">
                ...
                <div class="d-sm-flex d-block align-items-center justify-content-between mb-9">
                  <div class="mb-3 mb-sm-0">
                    <h5 class="card-title fw-semibold"><i class="fa fa-bars"></i> Mettre a jour Categorie</h5>
                  </div>
                  <div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-control-sm" name="icon">
                                        <option value="coffee" {{$category->icon == 'coffee'? 'selected':''}}>Cafe</option>
                                        <option value="hamburger" {{$category->icon == 'hamburger'? 'selected':''}}>Hamburger</option>
                                        <option value="utensils" {{$category->icon == 'utensils'? 'selected':''}}>Utensils</option>
                                        <option value="cocktail" {{$category->icon == 'cocktail'? 'selected':''}}>Boissons</option>
                                    </select>
                                </div>
                            </div>
                        </div>
